...
describe("Integration Tests", () => {
  ...
  describe("Complete workflow with Zod", () => {
    it("should generate complete Zod validators for all entities", async () => {
      ...
      expect(result).toContain("author: z.number()"); // User ID type
      ...
      expect(result).toContain("post: z.string()"); // Post ID type
      expect(result).toContain("author: z.number()"); // User ID type
    });
  });
  ...
  describe("Complete workflow with Valibot", () => {
    it("should generate complete Valibot validators for all entities", async () => {
      ...
      expect(result).toContain("author: v.number()"); // User ID type
      ...
      expect(result).toContain("post: v.string()"); // Post ID type
      expect(result).toContain("author: v.number()"); // User ID type
    });
  });
  ...
  describe("Entity parsing integration", () => {
    it("should correctly parse and transform complex entity relationships", async () => {
      ...
      // Check that entity references are replaced with ID types
      ...
      expect(result).toContain("author: number"); // User ID type
      ...
      expect(result).toContain("post: string"); // Post ID type
      expect(result).toContain("author: number"); // User ID type
